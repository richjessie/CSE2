// The program computes the cost of buying some BigMacs. It uses the 
// scanner to obtain how many Big Macs, the cost per Big Mac, and 
// the percentage tax in PA of 6%
...
public class BigMac {
    ...
    System.out.print(
        ...
        taxRate/=100; // user enters tax rate but proportion is wanted
        double cost$;
        int dollars, // whole dollar amount of of cost,
